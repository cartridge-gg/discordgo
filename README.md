# discordgo (cartridge-gg fork)

> **Fork notice.** This is Cartridge's fork of [bwmarrin/discordgo](https://github.com/bwmarrin/discordgo) v0.29.0, extended with native support for Discord's [DAVE (Distributed Audio/Video E2EE) protocol](https://daveprotocol.com) via CGO bindings to [discord/libdave](https://github.com/discord/libdave). Upstream does not yet implement DAVE, so any voice connect to a DAVE-enforcing server closes with code 4017. We added DAVE so our bots can listen to voice channels in servers that require E2EE.
>
> Everything non-voice behaves identically to upstream. If you don't need DAVE, use bwmarrin/discordgo.
